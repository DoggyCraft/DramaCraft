...
public class LanguageManager
{
	public static enum LANGUAGESTRING
	{
		...
		ERROR_ONLYIMPERIALSCANVOTEFORKING,
		ERROR_ONLYIMPERIALSCANBENOBLE,
		ERROR_ONLYIMPERIALCANVOTEFORNOBLE,
		ERROR_ONLYREBELSCANVOTEFORINNERCIRCLE,
		ERROR_ONLYREBELCANVOTEFORINNERCIRCLE,
		ERROR_ONLYREBELSCANBEINNERCIRCLE,
		ERROR_ONLYREBELSCANVOTEFORRINGLEADER,
		ERROR_ONLYINNERCIRCLECANBERINGLEADER,
		NEW_VOTE_BROADCAST_KING,
		NEW_VOTE_BROADCAST_NOBLE,
		NEW_VOTE_BROADCAST_INNERCIRCLE,
		NEW_VOTE_BROADCAST_QUEEN,
		NEW_VOTE_BROADCAST_RINGLEADER1,
		NEW_VOTE_BROADCAST_RINGLEADER2,
		NEW_VOTE_BROADCAST_PHANTOMS,
		NEW_VOTE_BROADCAST_DAY,
		NEW_VOTE_BROADCAST_NIGHT,
		NEW_VOTE_BROADCAST_SUN,
		NEW_VOTE_BROADCAST_RAIN,
		NEW_VOTE_BROADCAST_GENERAL,
		NEW_VOTE_BROADCAST_REVOLUTION,
		...
		VOTING_COMMANDS_VOTE_DESC_PHANTOMS,
		...
		VOTING_COMMANDS_VOTE_DESC_INNERCIRCLE,
		VOTING_COMMANDS_VOTE_DESC_INNERCIRCLE_KICK,
		VOTE_KING_CHANGE,
		...
		VOTE_ALREADY_SUN,
		VOTE_ALREADY_RAIN,
		VOTE_ALREADY_RINGLEADER,
		VOTE_ALREADY_INNERCIRCLE,
		VOTE_ALREADY_NOBLE,
		VOTE_ALREADY_DISABLE_PHANTOMS,
		...
		ERROR_ONLYIMPERIALSCANVOTEFORQUEEN, ERROR_ONLYREBELSCANVOTEFORINNERCIRCLEKICK, ERROR_ONLYINNERCIRCLECANBEKICKEDFROMINNERCIRCLE, ERROR_ONLYIMPERIALSCANVOTEFORNOBLEKICK, ERROR_ONLYNOBLESCANBEKICKEDFROMNOBLES, ERROR_ONLYINNERCIRCLECANKICKINNERCIRCLE, ERROR_ONLYNOBLESCANVOTEFORNOBLEKICK, ERROR_QUESTIONTOOSHORT, INFO_REBEL_REVOLUTION
	}
